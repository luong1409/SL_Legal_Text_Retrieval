...
if __name__ == "__main__":
    ...
    model_configs = {
        ...
        # },
        'PhoBERT': {
            "path_data_org": 'legal_text_retrieval/data/zac2021-ltr-data/',
            "path_c_code": 'legal_text_retrieval/data/zac2021-ltr-data/new_corpus.json',
            "tokenizer": 'vi_tokenize',
            "topk": 5,
            "do_lower_case": True,
            "max_seq_length": 256,
            "path_preprocessed_data": 'legal_text_retrieval/data/zalo-tfidfbm25150-full/',
            "model_path": 'legal_text_retrieval/settings/Tfbm150E5-full42/models',
        }
    }
    print(json.dumps(model_configs, indent=2))

    test_all_data = json.load(open('legal_text_retrieval/data/zac2021-ltr-data/test.json'))['items']
    ...
    for m_name, model_info in model_configs.items():
        ...
        #                 "civil_code_id": c_code_pred_by_tfidf[jj][i][1],
        #             }
        #             for i, lb in enumerate(predicted_labels[jj]) if lb == 0
        #         ] 
        #         for jj, s in enumerate(test_sents)
        #     ]
